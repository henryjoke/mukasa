...
<html lang="en">
<head>
	<title>St Joseph Mukasa Minor Seminary</title>
	<meta charset="UTF-8">
				...
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<div class="content">
								<div class="hs-subtitle">Life of a Minor Seminarian</div>
								<h2 class="hs-title">The Harvest is Great, but the Laborers are Few....</h2>
								<p class="hs-des">If you are a young man of high school age who has a vocation, then St. Joseph Mukasa Seminary may be the place for you. Our five-year course of studies offers the regular high school curriculum, with an emphasis on theology.</p>
