...
<html lang="en">
<head>
	<title>Mukasa - About Mukasa Seminary</title>
	<meta charset="UTF-8">
	<meta name="description" content="Mukasa University Template">
	<meta name="keywords" content="event, Mukasa, creative, html">
	...
	<section class="about-section spad pt-0">
		<div class="container">
			<div class="section-title text-center">
				<h3>WELCOME TO ST. Mukasa Minor Seminary</h3>
				<p>A vocation to the priesthood is often compared to a seed.</p>
			</div>
			<div class="row">
		...
		<div class="container">
			<div class="testimonial-slider owl-carousel">
				<div class="ts-item">
					<div class="row">
						<div class="col-md-3">
							<div class="ts-author-pic set-bg" data-setbg="img/member/3.jpg"></div>
						</div>
